...
class TestTicTacToe(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.game_large = start_new_game(self.x, self.o, board=[
                ["-", "-", "-", "-"],
                ["-", "-", "-", "-"],
                ["-", "-", "-", "-"],
                ["-", "-", "-", "-"]
    ...
    def test_start_new_game_larger_board(self):
    ...
    def test_is_valid_position_larger_board(self):
        game = start_new_game(self.x, self.o, board=[
                ["-", "-", "-", "-"],
                ["-", "-", "-", "-"],
                ["-", "-", "-", "-"],
                ["-", "-", "-", "-"]
    ...
    def test_is_valid_position_invalid(self):
        ...
        for position in invalid_positions:
            self.assertFalse(_position_is_valid(game, position))
